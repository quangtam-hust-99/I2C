...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../test_core_apb_i2c.srcs/sources_1/bd/design_1/ipshared/9c7f" \
       +incdir+"$ref_dir/../../../../test_core_apb_i2c.srcs/sources_1/bd/design_1/ipshared/7e3a/hdl" \
       +incdir+"../../../../test_core_apb_i2c.srcs/sources_1/bd/design_1/ipshared/9c7f" \
       +incdir+"../../../../test_core_apb_i2c.srcs/sources_1/bd/design_1/ipshared/7e3a/hdl"
}
