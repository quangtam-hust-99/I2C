...
HD_PWD='D:/vivado/project/test_core_apb_i2c/test_core_apb_i2c.runs/design_1_top_core_i2c_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_top_core_i2c_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_top_core_i2c_0_0.tcl
