...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_div_clk is
  ...
  attribute SOFT_HLUTNM of \reg_data_in[7]_i_3\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \rx_status[0]_i_3\ : label is "soft_lutpair10";
...
\reg_data_in[7]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFDF"
    )
        port map (
...
\reg_data_in[7]_i_6\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFA0CFCFAFA0C0C0"
    )
        port map (
...
\reg_data_in_reg[7]_i_4\: unisim.vcomponents.MUXF7
     port map (
      I0 => \reg_data_in[7]_i_6_n_0\,
      I1 => \reg_data_in[7]_i_7_n_0\,
      O => \reg_data_in_reg[7]_i_4_n_0\,
      S => \rd_ptr_reg__0\(2)
    );
\reg_data_in_reg[7]_i_5\: unisim.vcomponents.MUXF7
     port map (
      I0 => \reg_data_in[7]_i_8_n_0\,
      I1 => \reg_data_in[7]_i_9_n_0\,
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_i2c_master is
  ...
  attribute SOFT_HLUTNM of \Q[0]_i_3\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \Q[1]_i_3\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \Q[1]_i_8\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \Q[3]_i_3\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \Q[3]_i_4\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \Q[3]_i_7\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \counter[0]_i_1__1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \counter[1]_i_1__1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \counter[3]_i_1__1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \counter[4]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \counter[5]_i_4\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \counter_byte[1]_i_2\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \counter_byte[1]_i_3\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \counter_byte[4]_i_2\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \counter_byte[6]_i_2\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \counter_byte[6]_i_3\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \counter_byte[6]_i_4\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \counter_byte[7]_i_3\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \data_out[7]_i_3\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of scl_o_INST_0 : label is "soft_lutpair15";
