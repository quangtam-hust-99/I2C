...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_apb_interface is
  port (
    ...
    \counter_byte_reg[7]\ : out STD_LOGIC_VECTOR ( 3 downto 0 );
    ...
    \counter_byte_reg[7]_1\ : in STD_LOGIC_VECTOR ( 7 downto 0 );
...
counter_byte1_carry_i_5: unisim.vcomponents.LUT4
    generic map(
      ...
      I1 => \counter_byte_reg[7]_1\(7),
      I2 => \^counter_byte_reg[7]_0\(6),
      I3 => \counter_byte_reg[7]_1\(6),
      O => \counter_byte_reg[7]\(3)
    );
counter_byte1_carry_i_6: unisim.vcomponents.LUT4
    generic map(
      ...
      I1 => \counter_byte_reg[7]_1\(5),
      I2 => \^counter_byte_reg[7]_0\(4),
      I3 => \counter_byte_reg[7]_1\(4),
      O => \counter_byte_reg[7]\(2)
    );
counter_byte1_carry_i_7: unisim.vcomponents.LUT4
    generic map(
      ...
      I1 => \counter_byte_reg[7]_1\(3),
      I2 => \^counter_byte_reg[7]_0\(2),
      I3 => \counter_byte_reg[7]_1\(2),
      O => \counter_byte_reg[7]\(1)
    );
counter_byte1_carry_i_8: unisim.vcomponents.LUT4
    generic map(
      ...
      I1 => \counter_byte_reg[7]_1\(1),
      I2 => \^counter_byte_reg[7]_0\(0),
      I3 => \counter_byte_reg[7]_1\(0),
      O => \counter_byte_reg[7]\(0)
    );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_div_clk is
  ...
  signal \^rx_status_reg[0]\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \Q[1]_i_4\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \Q[1]_i_6\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \Q[1]_i_7\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \Q[2]_i_5\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \Q[3]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of clk_en_i_1 : label is "soft_lutpair15";
  ...
  attribute SOFT_HLUTNM of \counter[7]_i_2\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \counter_byte[7]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \reg_data_in[7]_i_1\ : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of sta_sto_i_1 : label is "soft_lutpair15";
begin
...
\Q[1]_i_8\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAA8AAA888880000"
    )
        port map (
      I0 => \^sclk\,
      I1 => Q(0),
      I2 => sda_i,
      I3 => \tx_apb_addr_reg[0]\(0),
      I4 => i_ready,
      I5 => Q(2),
      O => \Q[1]_i_8_n_0\
    );
\Q[2]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I1 => Q(2),
      I2 => \Q[2]_i_3_n_0\,
      I3 => \counter_byte_reg[4]\,
      I4 => \Q[2]_i_5_n_0\,
      O => \^d\(2)
    );
\Q[2]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000A000E0E0E0E0"
    )
        port map (
      I0 => Q(1),
      I1 => sda_i,
...
\Q[2]_i_5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFF07F7"
    )
        port map (
...
\rx_status[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => PENABLE,
      I4 => \^rx_status_reg[0]\,
      I5 => \rx_status_reg[0]_1\,
      O => \rx_status_reg[0]_0\
    );
...
sta_sto_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"12"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_i2c_master is
  ...
  signal sta_sto_reg_n_0 : STD_LOGIC;
  signal NLW_counter_byte1_carry_O_UNCONNECTED : STD_LOGIC_VECTOR ( 3 downto 0 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \Q[0]_i_2\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \Q[0]_i_3\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \Q[0]_i_6\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \Q[1]_i_2\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \Q[1]_i_3\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \Q[1]_i_9\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \Q[2]_i_4\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \Q[2]_i_6\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \counter[2]_i_2\ : label is "soft_lutpair17";
  ...
  attribute SOFT_HLUTNM of \counter[7]_i_3\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \counter_byte[4]_i_2\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \counter_byte[6]_i_2\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \counter_byte[6]_i_3\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \counter_byte[6]_i_4\ : label is "soft_lutpair20";
  ...
  attribute SOFT_HLUTNM of sda_o_i_2 : label is "soft_lutpair17";
begin
  E(0) <= \^e\(0);
...
\Q[1]_i_9\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\counter_byte[7]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"D1D1F1F0F0F0D100"
    )
        port map (
      I0 => \counter_byte[7]_i_3_n_0\,
      I1 => counter_byte1,
      I2 => \tx_apb_data_cnt_reg[7]_0\(7),
      I3 => Q_0(3),
      I4 => Q_0(1),
      I5 => Q_0(2),
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_top_core_i2c is
  ...
  signal i2c_master_n_43 : STD_LOGIC;
...
apb_interface: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_apb_interface
     port map (
      ...
      counter(2 downto 0) => counter(2 downto 0),
      \counter_byte_reg[7]\(3) => apb_interface_n_37,
      \counter_byte_reg[7]\(2) => apb_interface_n_38,
      \counter_byte_reg[7]\(1) => apb_interface_n_39,
      \counter_byte_reg[7]\(0) => apb_interface_n_40,
      \counter_byte_reg[7]_0\(7 downto 0) => data_cnt(7 downto 0),
      \counter_byte_reg[7]_1\(7 downto 0) => counter_byte(7 downto 0),
      ...
      \rx_status_reg[0]_1\ => i2c_master_n_46,
...
i2c_master: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_i2c_master
     port map (
      ...
      Q(7 downto 0) => counter_byte(7 downto 0),
      S(3) => apb_interface_n_6,
      S(2) => apb_interface_n_7,
      S(1) => apb_interface_n_8,
      S(0) => apb_interface_n_9,
      ...
      counter_reg(15 downto 0) => \div_clk/counter_reg\(15 downto 0),
      \counter_reg[0]_0\ => i2c_master_n_43,
      \counter_reg[2]_0\ => apb_interface_n_49,
      i_ready => i_ready,
      \mem_reg[15][7]\(7 downto 0) => data_out(7 downto 0),
      \rx_status_reg[0]\ => i2c_master_n_31,
      \rx_status_reg[0]_0\ => i2c_master_n_46,
      \rx_status_reg[0]_1\ => apb_interface_n_0,
      scl_o => scl_o,
      sda_i => sda_i,
      sda_o => sda_o,
