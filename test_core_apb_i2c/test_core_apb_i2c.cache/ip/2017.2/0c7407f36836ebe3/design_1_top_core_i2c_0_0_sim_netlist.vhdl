...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_apb_interface is
  port (
    ...
    \counter_byte_reg[0]\ : out STD_LOGIC_VECTOR ( 3 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_div_clk is
  ...
  attribute SOFT_HLUTNM of \Q[2]_i_3\ : label is "soft_lutpair13";
  ...
  attribute SOFT_HLUTNM of \reg_data_in[7]_i_1\ : label is "soft_lutpair12";
...
\Q[1]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0FFF0FFF1FFFFFFF"
    )
        port map (
      I0 => \counter_byte_reg[3]\,
      I1 => \counter_byte_reg[6]\,
      I2 => \^sclk\,
      I3 => Q(1),
      I4 => Q(2),
      I5 => Q(0),
...
\reg_data_in[7]_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FBFF"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo_generator is
  ...
  signal \counter_reg[1]_i_1__0_n_0\ : STD_LOGIC;
  signal \counter_reg[2]_i_1__0_n_0\ : STD_LOGIC;
  signal \counter_reg[3]_i_1__0_n_0\ : STD_LOGIC;
  signal \counter_reg[3]_i_2__0_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \wr_ptr[1]_i_1__0\ : label is "soft_lutpair3";
...
\counter_reg[0]\: unisim.vcomponents.LDCE
    generic map(
      INIT => '0'
        ...
        port map (
      CLR => '0',
      D => \counter_reg[0]_i_1__0_n_0\,
      G => \counter_reg[3]_i_2__0_n_0\,
      GE => '1',
      Q => counter(0)
    );
\counter_reg[0]_i_1__0\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => counter(0),
      O => \counter_reg[0]_i_1__0_n_0\
    );
\counter_reg[1]\: unisim.vcomponents.LDCE
    generic map(
      INIT => '0'
        ...
        port map (
      CLR => '0',
      D => \counter_reg[1]_i_1__0_n_0\,
      G => \counter_reg[3]_i_2__0_n_0\,
      GE => '1',
      Q => counter(1)
    );
\counter_reg[1]_i_1__0\: unisim.vcomponents.LUT6
    generic map(
...
\counter_reg[2]\: unisim.vcomponents.LDCE
    generic map(
      INIT => '0'
        ...
        port map (
      CLR => '0',
      D => \counter_reg[2]_i_1__0_n_0\,
      G => \counter_reg[3]_i_2__0_n_0\,
      GE => '1',
      Q => counter(2)
    );
\counter_reg[2]_i_1__0\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"44BBFF00FF00BB40"
    )
        port map (
      I0 => wr_ptr1,
      I1 => apb_rxff_rd,
...
\counter_reg[3]\: unisim.vcomponents.LDCE
    generic map(
      INIT => '0'
        ...
        port map (
      CLR => '0',
      D => \counter_reg[3]_i_1__0_n_0\,
      G => \counter_reg[3]_i_2__0_n_0\,
      GE => '1',
      Q => counter(3)
    );
\counter_reg[3]_i_1__0\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => apb_rxff_rd,
      I5 => wr_ptr1,
      O => \counter_reg[3]_i_1__0_n_0\
    );
\counter_reg[3]_i_2__0\: unisim.vcomponents.LUT6
    generic map(
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo_generator_0 is
  ...
  attribute XILINX_LEGACY_PRIM of \counter_reg[1]\ : label is "LD";
  attribute SOFT_HLUTNM of \counter_reg[1]_i_1\ : label is "soft_lutpair5";
  attribute XILINX_LEGACY_PRIM of \counter_reg[2]\ : label is "LD";
  attribute SOFT_HLUTNM of \counter_reg[2]_i_1\ : label is "soft_lutpair5";
  attribute XILINX_LEGACY_PRIM of \counter_reg[3]\ : label is "LD";
  ...
  attribute SOFT_HLUTNM of \reg_data_in[7]_i_3\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \wr_ptr[0]_i_1__0\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \wr_ptr[1]_i_1\ : label is "soft_lutpair9";
...
\counter_reg[2]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"6AA96A6A"
    )
        port map (
...
\reg_data_in[7]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFF0001"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_i2c_master is
  port (
    ...
    i2c_done : out STD_LOGIC;
    \reg_data_in_reg[7]_0\ : out STD_LOGIC;
    scl_o : out STD_LOGIC;
    \rx_status_reg[0]\ : out STD_LOGIC;
    \mem_reg[15][7]\ : out STD_LOGIC_VECTOR ( 7 downto 0 );
    PCLK : in STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_i2c_master is
  ...
  attribute SOFT_HLUTNM of \Q[0]_i_3\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \Q[1]_i_2\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \Q[1]_i_7\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \Q[2]_i_4\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \Q[3]_i_5\ : label is "soft_lutpair24";
  ...
  attribute SOFT_HLUTNM of \counter[5]_i_3\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \counter[5]_i_4\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \counter_byte[4]_i_2\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \counter_byte[6]_i_2\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \counter_byte[6]_i_3\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \counter_byte[6]_i_4\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \counter_byte[7]_i_3\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \data_out[7]_i_3\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of scl_o_INST_0 : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of sda_o_i_2 : label is "soft_lutpair16";
begin
  E(0) <= \^e\(0);
  Q(0) <= \^q\(0);
...
\Q[2]_i_6\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\counter_byte[1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"F44F4444"
    )
        port map (
...
div_clk: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_div_clk
     port map (
      ...
      \counter_byte_reg[6]\ => \Q[1]_i_7_n_0\,
      ...
      \counter_reg[2]_1\ => \Q[1]_i_2_n_0\,
      \counter_reg[2]_2\ => \counter[5]_i_3_n_0\,
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_top_core_i2c is
  ...
  signal i2c_master_n_46 : STD_LOGIC;
...
apb_interface: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_apb_interface
     port map (
      ...
      \counter_byte_reg[0]\(3) => apb_interface_n_37,
      \counter_byte_reg[0]\(2) => apb_interface_n_38,
      \counter_byte_reg[0]\(1) => apb_interface_n_39,
      \counter_byte_reg[0]\(0) => apb_interface_n_40,
      ...
      \tx_ctrl_reg[0]_0\ => apb_interface_n_5
    );
...
i2c_master: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_i2c_master
     port map (
      ...
      \reg_data_in_reg[7]_0\ => i2c_master_n_46,
