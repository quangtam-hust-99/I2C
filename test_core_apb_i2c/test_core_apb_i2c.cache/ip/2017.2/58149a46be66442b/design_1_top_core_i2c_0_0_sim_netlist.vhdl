...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_apb_interface is
  port (
    ...
    \counter_reg[2]\ : in STD_LOGIC_VECTOR ( 2 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_apb_interface is
  ...
  signal apb_txff_wr_i_1_n_0 : STD_LOGIC;
  ...
  signal \tx_apb_data[7]_i_1_n_0\ : STD_LOGIC;
...
apb_rxff_rd_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAA2AA00000080"
    )
        port map (
      I0 => \^apb_rxff_rd_reg_0\,
      I1 => PADDR(0),
      I2 => PADDR(2),
      I3 => PWRITE,
      I4 => PADDR(1),
...
sda_o_reg_i_4: unisim.vcomponents.MUXF7
     port map (
      I0 => sda_o_i_7_n_0,
      I1 => sda_o_i_8_n_0,
      O => sda_o_reg,
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_div_clk is
  port (
    ...
    \counter_reg[2]_0\ : in STD_LOGIC_VECTOR ( 2 downto 0 );
    ...
    \counter_byte_reg[4]\ : in STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_div_clk is
  ...
  signal \reg_data_in[7]_i_3_n_0\ : STD_LOGIC;
  signal \^sclk\ : STD_LOGIC;
  signal \^wr_ptr_reg[0]\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \Q[1]_i_6\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \Q[2]_i_2\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \counter[3]_i_2\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \counter[5]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \counter_byte[7]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \reg_data_in[7]_i_3\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \rx_status[0]_i_3\ : label is "soft_lutpair11";
...
\Q[1]_i_6\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"88888828"
    )
        port map (
...
\Q[1]_i_7\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FEF00000FE000000"
    )
        port map (
      I0 => sda_i,
      I1 => \tx_apb_addr_reg[0]\(0),
      I2 => Q(0),
      I3 => Q(2),
      I4 => \^sclk\,
      I5 => i_ready,
...
\Q[3]_i_5\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \counter_byte_reg[7]\(0),
      I3 => \counter_byte_reg[7]\(1),
      I4 => \counter_byte_reg[5]\,
      I5 => \^wr_ptr_reg[0]\,
      O => \Q[3]_i_5_n_0\
    );
...
\reg_data_in[7]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \^d\(2),
      I3 => \^d\(0),
      I4 => \reg_data_in[7]_i_3_n_0\,
      I5 => \Q_reg[0]\,
      O => E(0)
    );
\reg_data_in[7]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\wr_ptr[3]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFF7"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo_generator is
  ...
  attribute SOFT_HLUTNM of \wr_ptr[1]_i_1__0\ : label is "soft_lutpair4";
...
\rd_ptr[3]_i_1__0\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"AAAAAAA8"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo_generator_0 is
  ...
  signal \reg_data_in_reg[7]_i_6_n_0\ : STD_LOGIC;
  signal wr_ptr1 : STD_LOGIC;
  signal \wr_ptr[0]_i_1__0_n_0\ : STD_LOGIC;
  signal \wr_ptr_reg__0\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \rd_ptr[0]_i_1__0\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \rd_ptr[1]_i_1__0\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \rd_ptr[2]_i_1__0\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \rd_ptr[3]_i_2__0\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \wr_ptr[0]_i_1__0\ : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of \wr_ptr[3]_i_2\ : label is "soft_lutpair6";
begin
\counter[0]_i_1__0\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00000F0F0F0E0000"
    )
        port map (
      I0 => \counter_reg__0\(2),
      I1 => \counter_reg__0\(1),
...
\reg_data_in_reg[7]_i_2\: unisim.vcomponents.MUXF8
     port map (
      I0 => \reg_data_in_reg[7]_i_5_n_0\,
      I1 => \reg_data_in_reg[7]_i_6_n_0\,
      O => D(7),
      S => \rd_ptr_reg__0\(3)
    );
...
\reg_data_in_reg[7]_i_6\: unisim.vcomponents.MUXF7
     port map (
      I0 => \reg_data_in[7]_i_9_n_0\,
      I1 => \reg_data_in[7]_i_10_n_0\,
      O => \reg_data_in_reg[7]_i_6_n_0\,
      S => \rd_ptr_reg__0\(2)
    );
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_i2c_master is
  port (
    ...
    E : out STD_LOGIC_VECTOR ( 0 to 0 );
    \Q_reg[3]_0\ : out STD_LOGIC_VECTOR ( 7 downto 0 );
    \wr_ptr_reg[0]\ : out STD_LOGIC;
    i2c_done : out STD_LOGIC;
    scl_o : out STD_LOGIC;
    \rx_status_reg[0]\ : out STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_i2c_master is
  ...
  signal \^q_reg[3]_0\ : STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  signal \counter_byte[1]_i_2_n_0\ : STD_LOGIC;
  signal \counter_byte[1]_i_3_n_0\ : STD_LOGIC;
  ...
  signal \counter_byte[6]_i_3_n_0\ : STD_LOGIC;
  signal \counter_byte[6]_i_4_n_0\ : STD_LOGIC;
  ...
  signal \reg_data_in[7]_i_4_n_0\ : STD_LOGIC;
  signal sclk : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \Q[0]_i_2\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \Q[0]_i_3\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \Q[1]_i_3\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \Q[1]_i_8\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \Q[3]_i_3\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \Q[3]_i_7\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \counter[0]_i_1__1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \counter[1]_i_1__1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \counter[3]_i_1__1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \counter[4]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \counter[5]_i_4\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \counter_byte[1]_i_2\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \counter_byte[1]_i_3\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \counter_byte[4]_i_2\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \counter_byte[6]_i_2\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \counter_byte[6]_i_3\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \counter_byte[6]_i_4\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \counter_byte[7]_i_3\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \data_out[7]_i_3\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \reg_data_in[7]_i_4\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of scl_o_INST_0 : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of sda_o_i_2 : label is "soft_lutpair20";
begin
  E(0) <= \^e\(0);
  Q(0) <= \^q\(0);
  \Q_reg[3]_0\(7 downto 0) <= \^q_reg[3]_0\(7 downto 0);
...
\Q[1]_i_5\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FF00FFFF57575757"
    )
        port map (
      I0 => Q_0(2),
      I1 => \counter_byte[4]_i_2_n_0\,
      I2 => \Q[1]_i_8_n_0\,
      I3 => \Q[3]_i_6_n_0\,
...
\Q[3]_i_7\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\counter[5]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"1F"
    )
        port map (
...
\counter_byte[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFA88A20022002"
        ...
        port map (
      I0 => \counter_byte[1]_i_2_n_0\,
      I1 => counter_byte1,
      I2 => \^q_reg[3]_0\(1),
      I3 => \^q_reg[3]_0\(0),
      I4 => \counter_byte[1]_i_3_n_0\,
      I5 => \tx_apb_data_cnt_reg[7]_0\(1),
      O => \counter_byte[1]_i_1_n_0\
    );
\counter_byte[1]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
      ...
      I1 => \^q\(0),
      I2 => Q_0(3),
      O => \counter_byte[1]_i_2_n_0\
    );
\counter_byte[1]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\counter_byte[3]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"F44F4444"
    )
        port map (
...
\counter_byte[4]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"F44F4444"
    )
        port map (
...
\counter_byte[5]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"4FF44444"
    )
        port map (
...
\counter_byte[6]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"00E2"
    )
        port map (
...
\counter_byte[6]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000001"
    )
        port map (
...
\counter_byte[7]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8BAAAB8B8BAAAA00"
    )
        port map (
      I0 => \tx_apb_data_cnt_reg[7]_0\(7),
      I1 => counter_byte1,
      I2 => \counter_byte[7]_i_3_n_0\,
      I3 => Q_0(2),
      I4 => \^q\(0),
      I5 => Q_0(3),
      O => \counter_byte[7]_i_2_n_0\
    );
\counter_byte[7]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"5559"
    )
        port map (
      I0 => \^q_reg[3]_0\(7),
      I1 => \counter_byte[6]_i_4_n_0\,
      I2 => \^q_reg[3]_0\(5),
      I3 => \^q_reg[3]_0\(6),
...
div_clk: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_div_clk
     port map (
      ...
      PENABLE => PENABLE,
      PRESETn => PRESETn,
      Q(3 downto 2) => Q_0(3 downto 2),
      Q(1) => \^q\(0),
      Q(0) => Q_0(0),
      \Q_reg[0]\ => \reg_data_in[7]_i_4_n_0\,
      \Q_reg[0]_0\ => \Q[1]_i_3_n_0\,
      \Q_reg[1]\ => \counter[5]_i_4_n_0\,
      \Q_reg[1]_0\ => \Q[3]_i_4_n_0\,
      \Q_reg[2]\ => \Q[1]_i_5_n_0\,
      \Q_reg[2]_0\ => \Q[0]_i_2_n_0\,
      \Q_reg[2]_1\ => \Q[0]_i_3_n_0\,
      \Q_reg[3]\ => \Q[2]_i_4_n_0\,
      S(3 downto 0) => S(3 downto 0),
      \counter_byte_reg[0]\(0) => div_clk_n_40,
      \counter_byte_reg[3]\ => \counter_byte[4]_i_2_n_0\,
      \counter_byte_reg[4]\ => \Q[3]_i_3_n_0\,
      \counter_byte_reg[5]\ => \Q[3]_i_7_n_0\,
      \counter_byte_reg[7]\(1) => \^q_reg[3]_0\(7),
      \counter_byte_reg[7]\(0) => \^q_reg[3]_0\(4),
      ...
      \counter_reg[2]_0\(2 downto 0) => \^counter_reg[3]_0\(2 downto 0),
      \counter_reg[2]_1\ => \counter[5]_i_3_n_0\,
      \counter_reg[3]_0\ => counter_reg(0),
      \counter_reg[3]_1\ => div_clk_n_37,
      \counter_reg[7]_0\ => \Q[3]_i_6_n_0\,
      i2c_done => i2c_done,
      i_ready => i_ready,
      ...
      sda_i => sda_i,
      sta_sto => sta_sto,
      sta_sto_reg => div_clk_n_42,
      \tx_apb_addr_reg[0]\(0) => \tx_apb_addr_reg[0]\(0),
...
\reg_data_in[7]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_top_core_i2c is
  ...
  signal i2c_done : STD_LOGIC;
  signal i2c_master_n_31 : STD_LOGIC;
  signal i2c_master_n_45 : STD_LOGIC;
  signal i2c_master_n_48 : STD_LOGIC;
  signal i_ready : STD_LOGIC;
...
apb_interface: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_apb_interface
     port map (
      ...
      D(1) => fifo_rx_0_n_6,
      D(0) => fifo_rx_0_n_7,
      DI(3) => apb_interface_n_30,
      DI(2) => apb_interface_n_31,
      DI(1) => apb_interface_n_32,
      DI(0) => apb_interface_n_33,
      PADDR(2 downto 0) => PADDR(2 downto 0),
      PCLK => PCLK,
      PENABLE => PENABLE,
      ...
      S(3) => apb_interface_n_6,
      S(2) => apb_interface_n_7,
      S(1) => apb_interface_n_8,
      S(0) => apb_interface_n_9,
      apb_rxff_rd => apb_rxff_rd,
      apb_rxff_rd_reg_0 => apb_interface_n_5,
      apb_txff_wr => apb_txff_wr,
      clk_en_reg(2) => apb_interface_n_34,
      clk_en_reg(1) => apb_interface_n_35,
      clk_en_reg(0) => apb_interface_n_36,
      \counter_byte_reg[1]\(3) => apb_interface_n_37,
      \counter_byte_reg[1]\(2) => apb_interface_n_38,
      \counter_byte_reg[1]\(1) => apb_interface_n_39,
      \counter_byte_reg[1]\(0) => apb_interface_n_40,
      ...
      \counter_reg[2]\(2 downto 0) => counter(2 downto 0),
      i2c_done => i2c_done,
      i_ready => i_ready,
      \mem_reg[15][7]\(7 downto 0) => tx_apb_data(7 downto 0),
      \rx_status_reg[0]_0\ => apb_interface_n_0,
      \rx_status_reg[0]_1\ => i2c_master_n_48,
      sclk_reg(3) => apb_interface_n_26,
      sclk_reg(2) => apb_interface_n_27,
      sclk_reg(1) => apb_interface_n_28,
      sclk_reg(0) => apb_interface_n_29,
      sda_o_reg => apb_interface_n_49,
...
fifo_rx_0: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo_generator
     port map (
      ...
      Q(0) => Q(1),
      \Q_reg[1]\ => i2c_master_n_31,
      \Q_reg[3]\ => i2c_master_n_45,
      apb_rxff_rd => apb_rxff_rd,
...
i2c_master: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_i2c_master
     port map (
      ...
      PADDR(2 downto 0) => PADDR(2 downto 0),
      PCLK => PCLK,
      PENABLE => apb_interface_n_5,
      PRESETn => apb_interface_n_1,
      Q(0) => Q(1),
      \Q_reg[3]_0\(7 downto 0) => counter_byte(7 downto 0),
      S(3) => apb_interface_n_6,
      S(2) => apb_interface_n_7,
      S(1) => apb_interface_n_8,
      S(0) => apb_interface_n_9,
      ...
      counter_reg(15 downto 0) => \div_clk/counter_reg\(15 downto 0),
      \counter_reg[0]_0\ => i2c_master_n_31,
      \counter_reg[2]_0\ => apb_interface_n_49,
      \counter_reg[3]_0\(2 downto 0) => counter(2 downto 0),
      i2c_done => i2c_done,
      i_ready => i_ready,
      \mem_reg[15][7]\(7 downto 0) => data_out(7 downto 0),
      \rx_status_reg[0]\ => i2c_master_n_48,
      \rx_status_reg[0]_0\ => apb_interface_n_0,
      scl_o => scl_o,
      sda_i => sda_i,
      sda_o => sda_o,
      \tx_apb_addr_reg[0]\(0) => tx_apb_addr(0),
      \tx_apb_data_cnt_reg[7]\(3) => apb_interface_n_37,
      \tx_apb_data_cnt_reg[7]\(2) => apb_interface_n_38,
      \tx_apb_data_cnt_reg[7]\(1) => apb_interface_n_39,
      \tx_apb_data_cnt_reg[7]\(0) => apb_interface_n_40,
      \tx_apb_data_cnt_reg[7]_0\(7 downto 0) => data_cnt(7 downto 0),
      \tx_div_cnt_reg[14]\(2) => apb_interface_n_34,
      \tx_div_cnt_reg[14]\(1) => apb_interface_n_35,
      \tx_div_cnt_reg[14]\(0) => apb_interface_n_36,
      \tx_div_cnt_reg[15]\(3) => apb_interface_n_26,
      \tx_div_cnt_reg[15]\(2) => apb_interface_n_27,
      \tx_div_cnt_reg[15]\(1) => apb_interface_n_28,
      \tx_div_cnt_reg[15]\(0) => apb_interface_n_29,
      \tx_div_cnt_reg[15]_0\(15 downto 0) => div_cnt(15 downto 0),
      \wr_ptr_reg[0]\ => i2c_master_n_45
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
