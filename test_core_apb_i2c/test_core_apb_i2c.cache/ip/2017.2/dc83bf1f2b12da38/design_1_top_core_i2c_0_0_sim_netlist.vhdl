...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_div_clk is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \Q[1]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \Q[1]_i_5\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \Q[1]_i_7\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \Q[2]_i_10\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \Q[2]_i_4\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \Q[3]_i_4\ : label is "soft_lutpair15";
...
\Q[1]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"040404040F0F0F00"
    )
        port map (
      I0 => \counter_reg[4]_0\,
      I1 => \counter_reg[7]_2\,
      I2 => \Q[1]_i_7_n_0\,
      I3 => \counter_byte_reg[6]_0\,
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo_generator is
  signal \PADDR_2__s_net_1\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \PRDATA[7]_i_4\ : label is "soft_lutpair3";
...
begin
  \PADDR_2__s_net_1\ <= \PADDR_2__s_port_]\;
...
\PRDATA[7]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00F0200000000000"
    )
        port map (
      I0 => PRESETn,
      I1 => \PRDATA[7]_i_4_n_0\,
      I2 => PADDR(0),
      I3 => PADDR(2),
      I4 => PADDR(1),
      I5 => PWRITE_0,
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_i2c_master is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \Q[0]_i_6\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \Q[1]_i_6\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of \Q[1]_i_8\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \Q[2]_i_6\ : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of \Q[2]_i_8\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \Q[3]_i_5\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \counter[2]_i_2\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \counter[4]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \counter[6]_i_1\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of \counter[7]_i_3\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \counter[7]_i_4\ : label is "soft_lutpair21";
  ...
  attribute SOFT_HLUTNM of \counter_byte[5]_i_2\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \counter_byte[6]_i_2\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \counter_byte[7]_i_3\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \counter_byte[7]_i_4\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \counter_byte[7]_i_5\ : label is "soft_lutpair30";
  ...
  attribute SOFT_HLUTNM of sda_o_i_2 : label is "soft_lutpair19";
...
\Q[1]_i_8\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"01FF"
    )
        port map (
...
div_clk: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_div_clk
     port map (
      ...
      Q(1) => Q_0(1),
      Q(0) => \^q\(0),
      \Q_reg[0]\ => \Q[2]_i_2_n_0\,
      \Q_reg[0]_0\ => \Q[0]_i_6_n_0\,
      \Q_reg[1]\ => \Q[2]_i_7_n_0\,
      \Q_reg[1]_0\ => \Q[2]_i_3_n_0\,
      \Q_reg[2]\ => \Q_reg[2]_0\,
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_top_core_i2c is
  ...
  signal apb_interface_n_12 : STD_LOGIC;
  ...
  signal apb_interface_n_52 : STD_LOGIC;
...
apb_interface: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_apb_interface
     port map (
      ...
      DI(3) => apb_interface_n_33,
      DI(2) => apb_interface_n_34,
      DI(1) => apb_interface_n_35,
      DI(0) => apb_interface_n_36,
      E(0) => fifo_rx_0_n_8,
      PADDR(2 downto 0) => PADDR(2 downto 0),
      PCLK => PCLK,
      PENABLE => PENABLE,
      PRDATA(7 downto 0) => PRDATA(7 downto 0),
      \PRDATA_reg[0]_0\ => apb_interface_n_5,
      \PRDATA_reg[7]_0\ => apb_interface_n_8,
      PRESETn => PRESETn,
      PSEL => PSEL,
      PWDATA(15 downto 0) => PWDATA(15 downto 0),
      PWRITE => PWRITE,
      Q(15 downto 0) => div_cnt(15 downto 0),
      S(3) => apb_interface_n_9,
      S(2) => apb_interface_n_10,
      S(1) => apb_interface_n_11,
      S(0) => apb_interface_n_12,
      apb_rxff_rd => apb_rxff_rd,
      apb_rxff_rd_reg_0 => fifo_tx_0_n_11,
      apb_txff_wr => apb_txff_wr,
      apb_txff_wr_reg_0 => fifo_rx_0_n_10,
      clk_en_reg(2) => apb_interface_n_37,
      clk_en_reg(1) => apb_interface_n_38,
      clk_en_reg(0) => apb_interface_n_39,
      counter(2 downto 0) => counter(2 downto 0),
      \counter_byte_reg[1]\(3) => apb_interface_n_40,
      \counter_byte_reg[1]\(2) => apb_interface_n_41,
      \counter_byte_reg[1]\(1) => apb_interface_n_42,
      \counter_byte_reg[1]\(0) => apb_interface_n_43,
      ...
      \rx_status_reg[0]_1\ => apb_interface_n_7,
      \rx_status_reg[0]_2\ => i2c_master_n_49,
      sclk_reg(3) => apb_interface_n_29,
      sclk_reg(2) => apb_interface_n_30,
      sclk_reg(1) => apb_interface_n_31,
      sclk_reg(0) => apb_interface_n_32,
      sda_o_reg => apb_interface_n_52,
      sda_o_reg_0(0) => tx_apb_addr(0),
      \tx_apb_data_cnt_reg[0]_0\ => apb_interface_n_1,
      \tx_apb_data_reg[7]_0\ => apb_interface_n_6
    );
fifo_rx_0: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo_generator
     port map (
      ...
      E(0) => fifo_rx_0_n_8,
      PADDR(2 downto 0) => PADDR(2 downto 0),
      \PADDR_2__s_port_]\ => apb_interface_n_5,
      PCLK => PCLK,
      PENABLE => PENABLE,
      PRESETn => PRESETn,
...
i2c_master: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_i2c_master
     port map (
      ...
      counter_reg(15 downto 0) => \div_clk/counter_reg\(15 downto 0),
      \counter_reg[2]_0\ => apb_interface_n_52,
      ...
      \tx_apb_data_cnt_reg[7]\(3) => apb_interface_n_40,
      \tx_apb_data_cnt_reg[7]\(2) => apb_interface_n_41,
      \tx_apb_data_cnt_reg[7]\(1) => apb_interface_n_42,
      \tx_apb_data_cnt_reg[7]\(0) => apb_interface_n_43,
      \tx_apb_data_cnt_reg[7]_0\(7 downto 0) => data_cnt(7 downto 0),
      \tx_div_cnt_reg[14]\(2) => apb_interface_n_37,
      \tx_div_cnt_reg[14]\(1) => apb_interface_n_38,
      \tx_div_cnt_reg[14]\(0) => apb_interface_n_39,
      \tx_div_cnt_reg[15]\(3) => apb_interface_n_29,
      \tx_div_cnt_reg[15]\(2) => apb_interface_n_30,
      \tx_div_cnt_reg[15]\(1) => apb_interface_n_31,
      \tx_div_cnt_reg[15]\(0) => apb_interface_n_32,
