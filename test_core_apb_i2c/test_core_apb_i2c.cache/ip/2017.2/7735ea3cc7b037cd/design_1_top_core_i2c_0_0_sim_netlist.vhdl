...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_apb_interface is
  port (
    ...
    apb_txff_wr0 : out STD_LOGIC;
    \rx_status_reg[0]_1\ : out STD_LOGIC;
    \PRDATA_reg[0]_0\ : out STD_LOGIC;
    ...
    \PRDATA_reg[7]_0\ : out STD_LOGIC;
    PRDATA : out STD_LOGIC_VECTOR ( 7 downto 0 );
    \mem_reg[15][7]\ : out STD_LOGIC_VECTOR ( 7 downto 0 );
    \rx_status_reg[0]_2\ : in STD_LOGIC;
    PCLK : in STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_apb_interface is
  ...
  attribute SOFT_HLUTNM of \PRDATA[7]_i_5\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \PRDATA[7]_i_9\ : label is "soft_lutpair1";
...
\PRDATA[7]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
\PRDATA[7]_i_9\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00004000"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_div_clk is
  port (
    ...
    \counter_byte_reg[7]\ : in STD_LOGIC_VECTOR ( 3 downto 0 );
    \counter_reg[0]_0\ : in STD_LOGIC;
    \counter_reg[1]_0\ : in STD_LOGIC;
    \counter_reg[2]_2\ : in STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_div_clk is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \Q[0]_i_8\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \Q[1]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \Q[1]_i_5\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \Q[1]_i_6\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \Q[2]_i_9\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \Q[3]_i_4\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \counter[7]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \counter[7]_i_2\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \counter_byte[7]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \reg_data_in[7]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \rx_status[0]_i_3\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \wr_ptr[3]_i_3\ : label is "soft_lutpair14";
begin
...
\Q[1]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"000E0F0E000E000E"
    )
        port map (
      I0 => \counter_byte_reg[3]\,
      I1 => \counter_byte_reg[6]_1\,
      I2 => \Q[1]_i_6_n_0\,
      I3 => Q(0),
      I4 => \counter_reg[4]_0\,
      I5 => \counter_reg[2]_1\,
...
\Q[1]_i_6\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"1F"
    )
        port map (
...
\Q[2]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAAAAAAAAAAAB"
        ...
        port map (
      I0 => \Q[2]_i_9_n_0\,
      I1 => \counter_byte_reg[7]\(2),
      I2 => \counter_byte_reg[7]\(1),
      I3 => \counter_byte_reg[7]\(3),
      I4 => \counter_byte_reg[7]\(0),
      I5 => \counter_byte_reg[3]\,
      O => \Q[2]_i_4_n_0\
    );
...
\Q[2]_i_9\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FB"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo_generator is
  ...
  signal \PRDATA[7]_i_11_n_0\ : STD_LOGIC;
  signal \PRDATA[7]_i_4_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \PRDATA[7]_i_4\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \wr_ptr[0]_i_1__0\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \wr_ptr[1]_i_1__0\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \wr_ptr[2]_i_1__0\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \wr_ptr[3]_i_2__0\ : label is "soft_lutpair3";
begin
\PRDATA[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I0 => \rx_status_reg[0]\,
      I1 => PWRITE,
      I2 => \PRDATA_reg[0]_i_2_n_0\,
      I3 => \rd_ptr_reg__0\(3),
      I4 => \PRDATA_reg[0]_i_3_n_0\,
      O => D(0)
    );
...
\PRDATA[7]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"000400000F000000"
    )
        port map (
      I0 => \PRDATA[7]_i_4_n_0\,
      I1 => PRESETn,
      I2 => PSEL,
      I3 => PADDR(1),
      I4 => PADDR(0),
...
\PRDATA[7]_i_11\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFA0CFCFAFA0C0C0"
    )
        port map (
...
\PRDATA[7]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
\PRDATA_reg[7]_i_6\: unisim.vcomponents.MUXF7
     port map (
      I0 => \PRDATA[7]_i_10_n_0\,
      I1 => \PRDATA[7]_i_11_n_0\,
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo_generator_0 is
  ...
  attribute ORIG_REF_NAME of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo_generator_0 : entity is "fifo_generator";
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo_generator_0 is
  ...
  signal \^tx_apb_data_reg[7]\ : STD_LOGIC_VECTOR ( 0 to 0 );
  signal wr_ptr1 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \rd_ptr[1]_i_1__0\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \rd_ptr[2]_i_1__0\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \rd_ptr[3]_i_1__0\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \reg_data_in[7]_i_6\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \tx_apb_data[7]_i_3\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \wr_ptr[0]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \wr_ptr[1]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \wr_ptr[2]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \wr_ptr[3]_i_2\ : label is "soft_lutpair9";
begin
  \tx_apb_data_reg[7]\(0) <= \^tx_apb_data_reg[7]\(0);
apb_rxff_rd_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"B000303080000000"
    )
        port map (
      I0 => \tx_apb_data[7]_i_3_n_0\,
      I1 => \^tx_apb_data_reg[7]\(0),
      I2 => PSEL,
      I3 => PENABLE,
      I4 => PWRITE,
      I5 => apb_rxff_rd,
...
apb_txff_wr_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"C0448000"
    )
        port map (
      I0 => \^tx_apb_data_reg[7]\(0),
      I1 => PSEL,
      I2 => PENABLE,
      I3 => PWRITE,
      I4 => apb_txff_wr,
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_i2c_master is
  port (
    ...
    \Q_reg[2]_0\ : out STD_LOGIC_VECTOR ( 7 downto 0 );
    i2c_done : out STD_LOGIC;
    E : out STD_LOGIC_VECTOR ( 0 to 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_i2c_master is
  ...
  signal \^q_reg[2]_0\ : STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  signal \counter_byte[5]_i_3_n_0\ : STD_LOGIC;
  signal \counter_byte[5]_i_4_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \Q[0]_i_6\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \Q[0]_i_7\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \Q[0]_i_9\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of \Q[1]_i_7\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of \Q[2]_i_8\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \Q[3]_i_5\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \Q[3]_i_6\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of \counter[2]_i_2\ : label is "soft_lutpair26";
  ...
  attribute SOFT_HLUTNM of \counter[7]_i_4\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \counter_byte[2]_i_2\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \counter_byte[3]_i_2\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \counter_byte[4]_i_2\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \counter_byte[5]_i_2\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \counter_byte[5]_i_3\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \counter_byte[5]_i_4\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of \data_out[0]_i_2\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \data_out[7]_i_3\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of scl_o_INST_0 : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of sda_o_i_2 : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of sda_o_i_4 : label is "soft_lutpair23";
begin
  E(0) <= \^e\(0);
  Q(1 downto 0) <= \^q\(1 downto 0);
  \Q_reg[2]_0\(7 downto 0) <= \^q_reg[2]_0\(7 downto 0);
...
\Q[1]_i_7\: unisim.vcomponents.LUT3
    generic map(
      ...
      I0 => \^q\(0),
      I1 => sda_i,
      I2 => \tx_apb_addr_reg[0]\(0),
      O => \Q[1]_i_7_n_0\
    );
\Q[2]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"3000000000AA00AA"
    )
        port map (
      I0 => sda_i,
      I1 => \Q[2]_i_7_n_0\,
...
\Q[2]_i_7\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\Q[2]_i_8\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
\counter[7]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
...
\counter_byte[5]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I0 => \counter_byte[5]_i_2_n_0\,
      I1 => counter_byte1,
      I2 => \counter_byte[5]_i_3_n_0\,
      I3 => \^q_reg[2]_0\(5),
      I4 => \counter_byte[5]_i_4_n_0\,
      I5 => \tx_apb_data_cnt_reg[7]_0\(5),
      O => \counter_byte[5]_i_1_n_0\
    );
\counter_byte[5]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"E2"
    )
        port map (
...
\counter_byte[5]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000001"
    )
        port map (
      ...
      I3 => \^q_reg[2]_0\(0),
      I4 => \^q_reg[2]_0\(3),
      O => \counter_byte[5]_i_3_n_0\
    );
\counter_byte[5]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\counter_byte[7]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => Q_0(3),
      I3 => counter_byte1,
      I4 => \tx_apb_data_cnt_reg[7]_0\(7),
      I5 => \counter_byte[7]_i_3_n_0\,
      O => \counter_byte[7]_i_2_n_0\
    );
\counter_byte[7]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
div_clk: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_div_clk
     port map (
      ...
      Q(1) => Q_0(1),
      Q(0) => \^q\(0),
      \Q_reg[0]\ => \Q[3]_i_5_n_0\,
      \Q_reg[0]_0\ => \Q[2]_i_2_n_0\,
      \Q_reg[0]_1\ => \Q[0]_i_9_n_0\,
      \Q_reg[2]\ => \Q_reg[2]_1\,
      \Q_reg[2]_0\ => \Q[1]_i_4_n_0\,
      \Q_reg[2]_1\ => \Q[0]_i_7_n_0\,
      \Q_reg[2]_2\ => \Q[2]_i_6_n_0\,
      S(3 downto 0) => S(3 downto 0),
      \counter_byte_reg[0]\(0) => div_clk_n_40,
      \counter_byte_reg[3]\ => \counter_byte[4]_i_2_n_0\,
      \counter_byte_reg[6]\ => \Q[3]_i_3_n_0\,
      \counter_byte_reg[6]_0\ => \Q[2]_i_3_n_0\,
      \counter_byte_reg[6]_1\ => \Q[0]_i_6_n_0\,
      \counter_byte_reg[7]\(3 downto 0) => \^q_reg[2]_0\(7 downto 4),
      ...
      \counter_reg[2]_1\ => \counter[7]_i_4_n_0\,
      \counter_reg[2]_2\ => \^counter\(2),
      \counter_reg[3]_0\ => counter_reg(0),
      \counter_reg[3]_1\ => div_clk_n_39,
      \counter_reg[4]_0\ => \Q[2]_i_7_n_0\,
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_top_core_i2c is
  ...
  signal apb_interface_n_53 : STD_LOGIC;
...
apb_interface: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_apb_interface
     port map (
      ...
      \PRDATA_reg[0]_0\ => apb_interface_n_7,
      \PRDATA_reg[7]_0\ => apb_interface_n_53,
      PRESETn => PRESETn,
      PSEL => PSEL,
      ...
      apb_rxff_rd_reg_0 => fifo_tx_0_n_10,
      apb_txff_wr => apb_txff_wr,
      apb_txff_wr0 => apb_txff_wr0,
      apb_txff_wr_reg_0 => fifo_tx_0_n_11,
      ...
      \counter_reg[0]\(0) => fifo_tx_0_n_0,
      i2c_done => i2c_done,
      i_ready => i_ready,
      \mem_reg[15][7]\(7 downto 0) => tx_apb_data(7 downto 0),
      \rx_status_reg[0]_0\ => apb_interface_n_0,
      \rx_status_reg[0]_1\ => apb_interface_n_6,
      \rx_status_reg[0]_2\ => i2c_master_n_49,
...
fifo_rx_0: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo_generator
     port map (
      ...
      PSEL => apb_interface_n_53,
      PWRITE => apb_interface_n_7,
      \Q_reg[0]\ => i2c_master_n_33,
      apb_rxff_rd => apb_rxff_rd,
      \data_out_reg[7]\(7 downto 0) => data_out(7 downto 0),
      \rx_status_reg[0]\ => apb_interface_n_0
    );
fifo_tx_0: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo_generator_0
     port map (
      D(7) => fifo_tx_0_n_2,
      D(6) => fifo_tx_0_n_3,
      D(5) => fifo_tx_0_n_4,
      ...
      Q(0) => Q(0),
      apb_rxff_rd => apb_rxff_rd,
      apb_rxff_rd_reg => fifo_tx_0_n_10,
      apb_txff_wr => apb_txff_wr,
      apb_txff_wr0 => apb_txff_wr0,
      apb_txff_wr_reg => fifo_tx_0_n_11,
      i_txff_rd => i_txff_rd,
      \reg_data_in_reg[7]\ => fifo_tx_0_n_1,
      sclk_reg => i2c_master_n_47,
      \tx_apb_data_reg[7]\(0) => fifo_tx_0_n_0,
...
i2c_master: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_i2c_master
     port map (
      ...
      PADDR(2 downto 0) => PADDR(2 downto 0),
      PCLK => PCLK,
      PENABLE => apb_interface_n_6,
      PRESETn => apb_interface_n_1,
      Q(1) => Q(2),
      Q(0) => Q(0),
      \Q_reg[2]_0\(7 downto 0) => counter_byte(7 downto 0),
      \Q_reg[2]_1\ => i2c_master_n_47,
      S(3) => apb_interface_n_8,
      S(2) => apb_interface_n_9,
      S(1) => apb_interface_n_10,
      S(0) => apb_interface_n_11,
      ...
      \counter_reg[2]_1\ => fifo_tx_0_n_1,
      i2c_done => i2c_done,
      i_ready => i_ready,
