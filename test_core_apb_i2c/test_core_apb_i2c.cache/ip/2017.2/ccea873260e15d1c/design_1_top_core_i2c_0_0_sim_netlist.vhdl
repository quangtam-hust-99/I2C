...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_apb_interface is
  port (
    ...
    \counter_reg_2__s_port_\ : in STD_LOGIC
  );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_apb_interface is
  ...
  signal \counter_reg_2__s_net_1\ : STD_LOGIC;
  ...
  signal \tx_apb_addr[7]_i_2_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \PRDATA[7]_i_5\ : label is "soft_lutpair0";
...
begin
  ...
  \counter_reg_2__s_net_1\ <= \counter_reg_2__s_port_\;
  i_ready <= \^i_ready\;
...
\tx_apb_addr[7]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00020000"
    )
        port map (
      I0 => \tx_apb_addr[7]_i_2_n_0\,
      I1 => PADDR(2),
      I2 => PADDR(1),
      I3 => PADDR(0),
      I4 => PRESETn,
...
\tx_apb_addr[7]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
\tx_apb_data_cnt[7]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00200000"
    )
        port map (
...
\tx_div_cnt[15]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00800000"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_div_clk is
  port (
    ...
    \counter_byte_reg[5]\ : in STD_LOGIC;
    \counter_byte_reg[7]\ : in STD_LOGIC_VECTOR ( 1 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_div_clk is
  ...
  attribute SOFT_HLUTNM of \Q[1]_i_5\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \Q[1]_i_6\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \Q[2]_i_10\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \Q[2]_i_4\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \Q[3]_i_4\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \counter[7]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \counter[7]_i_2\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \counter_byte[7]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \reg_data_in[7]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \rx_status[0]_i_2\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \wr_ptr[3]_i_3\ : label is "soft_lutpair12";
begin
...
\Q[2]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo_generator is
  ...
  attribute SOFT_HLUTNM of \wr_ptr[2]_i_1__0\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \wr_ptr[3]_i_2__0\ : label is "soft_lutpair2";
begin
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo_generator_0 is
  port (
    \tx_apb_data_reg[0]\ : out STD_LOGIC;
    ...
    \tx_apb_data_reg[7]\ : in STD_LOGIC_VECTOR ( 7 downto 0 );
    PCLK : in STD_LOGIC;
    PRESETn_0 : in STD_LOGIC
  );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo_generator_0 is
  ...
  signal \tx_apb_data[7]_i_2_n_0\ : STD_LOGIC;
  signal \^tx_apb_data_reg[0]\ : STD_LOGIC;
  signal wr_ptr1 : STD_LOGIC;
  signal \wr_ptr[0]_i_1_n_0\ : STD_LOGIC;
  signal \wr_ptr_reg__0\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \counter[0]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \rd_ptr[0]_i_1__0\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \rd_ptr[1]_i_1__0\ : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of \wr_ptr[0]_i_1\ : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of \wr_ptr[3]_i_2\ : label is "soft_lutpair7";
begin
  \tx_apb_data_reg[0]\ <= \^tx_apb_data_reg[0]\;
...
\counter[1]_i_1__0\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \counter_reg__0\(1),
      I3 => \counter_reg__0\(0),
      I4 => \tx_apb_data[7]_i_2_n_0\,
      I5 => i_txff_rd,
      O => \counter[1]_i_1__0_n_0\
    );
\counter[2]_i_1__0\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAA5DAAA5AAA5AAA"
    )
        port map (
      I0 => \counter_reg__0\(2),
      I1 => \counter_reg__0\(3),
...
\tx_apb_data[7]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\tx_apb_data[7]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_i2c_master is
  ...
  signal \^q_reg[0]_0\ : STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \Q[0]_i_10\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of \Q[0]_i_7\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \Q[0]_i_8\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \Q[0]_i_9\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \Q[1]_i_7\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of \Q[2]_i_11\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \Q[2]_i_6\ : label is "soft_lutpair31";
  attribute SOFT_HLUTNM of \Q[2]_i_8\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \Q[2]_i_9\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \Q[3]_i_5\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \Q[3]_i_6\ : label is "soft_lutpair30";
  ...
  attribute SOFT_HLUTNM of \counter[7]_i_3\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \counter[7]_i_4\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \counter_byte[2]_i_2\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of \counter_byte[3]_i_2\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of \counter_byte[4]_i_2\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \counter_byte[5]_i_2\ : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of \counter_byte[5]_i_3\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \counter_byte[5]_i_4\ : label is "soft_lutpair31";
  attribute SOFT_HLUTNM of \counter_byte[6]_i_2\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \data_out[0]_i_2\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \data_out[7]_i_3\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of scl_o_INST_0 : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of sda_o_i_2 : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of sda_o_i_4 : label is "soft_lutpair19";
begin
  E(0) <= \^e\(0);
  Q(1 downto 0) <= \^q\(1 downto 0);
  \Q_reg[0]_0\(7 downto 0) <= \^q_reg[0]_0\(7 downto 0);
  counter(2 downto 0) <= \^counter\(2 downto 0);
  \mem_reg[15][7]\(7 downto 0) <= \^mem_reg[15][7]\(7 downto 0);
  sda_o <= \^sda_o\;
\Q[0]_i_10\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
\Q[0]_i_7\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
...
div_clk: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_div_clk
     port map (
      ...
      \Q_reg[0]_0\ => \Q[2]_i_3_n_0\,
      \Q_reg[0]_1\ => \Q[2]_i_8_n_0\,
      \Q_reg[0]_2\ => \Q[0]_i_10_n_0\,
      ...
      \counter_byte_reg[5]\ => \Q[0]_i_9_n_0\,
      \counter_byte_reg[6]\ => \Q[3]_i_3_n_0\,
      \counter_byte_reg[6]_0\ => \Q[2]_i_2_n_0\,
      \counter_byte_reg[6]_1\ => \Q[2]_i_11_n_0\,
      \counter_byte_reg[7]\(1) => \^q_reg[0]_0\(7),
      \counter_byte_reg[7]\(0) => \^q_reg[0]_0\(4),
...
apb_interface: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_apb_interface
     port map (
      ...
      D(1) => fifo_rx_0_n_6,
      D(0) => fifo_rx_0_n_7,
      DI(3) => apb_interface_n_28,
      DI(2) => apb_interface_n_29,
      DI(1) => apb_interface_n_30,
      DI(0) => apb_interface_n_31,
      E(0) => fifo_rx_0_n_8,
      PADDR(2 downto 0) => PADDR(2 downto 0),
      PCLK => PCLK,
      PENABLE => PENABLE,
      ...
      S(3) => apb_interface_n_4,
      S(2) => apb_interface_n_5,
      S(1) => apb_interface_n_6,
      S(0) => apb_interface_n_7,
      clk_en_reg(2) => apb_interface_n_32,
      clk_en_reg(1) => apb_interface_n_33,
      clk_en_reg(0) => apb_interface_n_34,
      counter(2 downto 0) => counter(2 downto 0),
      \counter_byte_reg[1]\(3) => apb_interface_n_35,
      \counter_byte_reg[1]\(2) => apb_interface_n_36,
      \counter_byte_reg[1]\(1) => apb_interface_n_37,
      \counter_byte_reg[1]\(0) => apb_interface_n_38,
      ...
      \counter_reg_2__s_port_\ => fifo_tx_0_n_0,
      i2c_done => i2c_done,
      i_ready => i_ready,
      \mem_reg[15][7]\(7 downto 0) => tx_apb_data(7 downto 0),
      \rx_status_reg[0]_0\ => apb_interface_n_0,
      \rx_status_reg[0]_1\ => apb_interface_n_3,
      \rx_status_reg[0]_2\ => i2c_master_n_49,
      sclk_reg(3) => apb_interface_n_24,
      sclk_reg(2) => apb_interface_n_25,
      sclk_reg(1) => apb_interface_n_26,
      sclk_reg(0) => apb_interface_n_27,
      sda_o_reg => apb_interface_n_47,
...
fifo_tx_0: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo_generator_0
     port map (
      ...
      \tx_apb_data_reg[0]\ => fifo_tx_0_n_0,
      \tx_apb_data_reg[7]\(7 downto 0) => tx_apb_data(7 downto 0)
    );
i2c_master: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_i2c_master
     port map (
      ...
      Q(1) => Q(2),
      Q(0) => Q(0),
      \Q_reg[0]_0\(7 downto 0) => counter_byte(7 downto 0),
      ...
      counter_reg(15 downto 0) => \div_clk/counter_reg\(15 downto 0),
      \counter_reg[2]_0\ => apb_interface_n_47,
      ...
      \tx_apb_data_cnt_reg[7]\(3) => apb_interface_n_35,
      \tx_apb_data_cnt_reg[7]\(2) => apb_interface_n_36,
      \tx_apb_data_cnt_reg[7]\(1) => apb_interface_n_37,
      \tx_apb_data_cnt_reg[7]\(0) => apb_interface_n_38,
      \tx_apb_data_cnt_reg[7]_0\(7 downto 0) => data_cnt(7 downto 0),
      \tx_div_cnt_reg[14]\(2) => apb_interface_n_32,
      \tx_div_cnt_reg[14]\(1) => apb_interface_n_33,
      \tx_div_cnt_reg[14]\(0) => apb_interface_n_34,
      \tx_div_cnt_reg[15]\(3) => apb_interface_n_24,
      \tx_div_cnt_reg[15]\(2) => apb_interface_n_25,
      \tx_div_cnt_reg[15]\(1) => apb_interface_n_26,
      \tx_div_cnt_reg[15]\(0) => apb_interface_n_27,
