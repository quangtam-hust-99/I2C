...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_apb_interface is
  port (
    ...
    \mem_reg[0][7]\ : out STD_LOGIC_VECTOR ( 7 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_apb_interface is
  ...
  attribute SOFT_HLUTNM of \rx_status[0]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \tx_ctrl[0]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \tx_data[7]_i_2\ : label is "soft_lutpair1";
begin
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_div_clk is
  ...
  attribute SOFT_HLUTNM of \Q[1]_i_7\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \Q[2]_i_3\ : label is "soft_lutpair14";
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo_generator_0 is
  port (
    ...
    \Q_reg[0]\ : in STD_LOGIC;
    PRESETn : in STD_LOGIC;
    \tx_data_reg[7]\ : in STD_LOGIC_VECTOR ( 7 downto 0 );
    PCLK : in STD_LOGIC;
    PRESETn_0 : in STD_LOGIC
  );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo_generator_0 is
  ...
  attribute SOFT_HLUTNM of \counter[2]_i_1__0\ : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of \reg_data_in[7]_i_3\ : label is "soft_lutpair7";
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_i2c_master is
  port (
    ...
    \Q_reg[1]_0\ : out STD_LOGIC_VECTOR ( 7 downto 0 );
    E : out STD_LOGIC_VECTOR ( 0 to 0 );
    i2c_done : out STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_i2c_master is
  ...
  signal \^q_reg[1]_0\ : STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \Q[0]_i_2\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \Q[0]_i_3\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \Q[1]_i_2\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \Q[1]_i_3\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \Q[2]_i_4\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \Q[3]_i_3\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \Q[3]_i_5\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \counter[0]_i_1__1\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \counter[1]_i_1__1\ : label is "soft_lutpair24";
  ...
  attribute SOFT_HLUTNM of \counter[5]_i_3\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \counter[5]_i_4\ : label is "soft_lutpair19";
  ...
  attribute SOFT_HLUTNM of \counter_byte[6]_i_3\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \counter_byte[6]_i_4\ : label is "soft_lutpair21";
...
begin
  E(0) <= \^e\(0);
  Q(0) <= \^q\(0);
  \Q_reg[1]_0\(7 downto 0) <= \^q_reg[1]_0\(7 downto 0);
  \counter_reg[0]_0\ <= \^counter_reg[0]_0\;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_top_core_i2c is
  ...
  signal i2c_done : STD_LOGIC;
  signal i2c_master_n_0 : STD_LOGIC;
  signal i2c_master_n_32 : STD_LOGIC;
...
apb_interface: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_apb_interface
     port map (
      ...
      \counter_byte_reg[0]\(3) => apb_interface_n_36,
      \counter_byte_reg[0]\(2) => apb_interface_n_37,
      \counter_byte_reg[0]\(1) => apb_interface_n_38,
      \counter_byte_reg[0]\(0) => apb_interface_n_39,
      ...
      i2c_done => i2c_done,
      i_ready => i_ready,
      \mem_reg[0][7]\(7 downto 0) => tx_data(7 downto 0),
...
fifo_tx_0: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo_generator_0
     port map (
      ...
      \tx_data_reg[7]\(7 downto 0) => tx_data(7 downto 0)
    );
i2c_master: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_i2c_master
     port map (
      ...
      PRESETn => PRESETn,
      Q(0) => Q(1),
      \Q_reg[1]_0\(7 downto 0) => counter_byte(7 downto 0),
      S(3) => apb_interface_n_5,
      S(2) => apb_interface_n_6,
      S(1) => apb_interface_n_7,
      S(0) => apb_interface_n_8,
