...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_div_clk is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \Q[1]_i_6\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \Q[2]_i_5\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \Q[2]_i_8\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \Q[3]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \counter[3]_i_2\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \counter[7]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \counter_byte[7]_i_1\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \rx_status[0]_i_3\ : label is "soft_lutpair9";
begin
...
\Q[2]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"4777"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_i2c_master is
  ...
  signal div_clk_n_38 : STD_LOGIC;
  signal div_clk_n_41 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \Q[0]_i_4\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \Q[0]_i_7\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \Q[1]_i_2\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \Q[1]_i_3\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \Q[1]_i_8\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \Q[2]_i_6\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \Q[3]_i_4\ : label is "soft_lutpair25";
  ...
  attribute SOFT_HLUTNM of \counter[7]_i_4\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \counter_byte[4]_i_2\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \counter_byte[5]_i_2\ : label is "soft_lutpair20";
  ...
  attribute SOFT_HLUTNM of \counter_byte[7]_i_4\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \counter_byte[7]_i_5\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \data_out[7]_i_3\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of scl_o_INST_0 : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of sda_o_i_2 : label is "soft_lutpair14";
begin
  E(0) <= \^e\(0);
...
\counter_byte[1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I1 => \tx_apb_data_cnt_reg[7]_0\(1),
      I2 => \^counter_byte_reg[7]_0\(0),
      I3 => \^counter_byte_reg[7]_0\(1),
      I4 => \counter_byte[7]_i_4_n_0\,
...
\counter_byte[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \^counter_byte_reg[7]_0\(2),
      I3 => \^counter_byte_reg[7]_0\(1),
      I4 => \^counter_byte_reg[7]_0\(0),
      I5 => \counter_byte[7]_i_4_n_0\,
...
\counter_byte[6]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => Q_0(2),
      I3 => counter_byte1,
      I4 => \tx_apb_data_cnt_reg[7]_0\(6),
      I5 => \counter_byte[6]_i_2_n_0\,
...
\counter_byte[7]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"44F4F444"
    )
        port map (
...
\counter_byte[7]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"00E2"
    )
        port map (
...
\counter_byte[7]_i_5\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
...
div_clk: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_div_clk
     port map (
      ...
      \Q_reg[0]\ => \Q[2]_i_4_n_0\,
      \Q_reg[1]\ => \Q[1]_i_2_n_0\,
      \Q_reg[2]\ => \Q[0]_i_2_n_0\,
      \Q_reg[2]_0\ => \Q[3]_i_4_n_0\,
      \Q_reg[2]_1\ => \Q[0]_i_7_n_0\,
      \Q_reg[3]\ => \Q[0]_i_4_n_0\,
      \Q_reg[3]_0\ => \Q[3]_i_5_n_0\,
      S(3 downto 0) => S(3 downto 0),
      \counter_byte_reg[0]\(0) => div_clk_n_38,
      \counter_byte_reg[3]\ => \counter_byte[4]_i_2_n_0\,
      \counter_byte_reg[4]\ => \Q[0]_i_3_n_0\,
      \counter_byte_reg[6]\ => \Q[1]_i_8_n_0\,
      ...
      \counter_reg[2]_1\ => \Q[1]_i_3_n_0\,
      \counter_reg[3]_0\ => counter_reg(0),
      \counter_reg[3]_1\ => div_clk_n_37,
      \counter_reg[3]_2\ => \counter_reg[3]_0\,
...
i2c_master: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_i2c_master
     port map (
      ...
      \counter_reg[3]_0\ => i2c_master_n_45,
      i_ready => i_ready,
