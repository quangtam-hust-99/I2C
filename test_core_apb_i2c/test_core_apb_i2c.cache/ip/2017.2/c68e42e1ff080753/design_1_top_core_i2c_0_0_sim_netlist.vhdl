...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_apb_interface is
  ...
  signal \tx_ctrl[0]_i_3_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \tx_ctrl[0]_i_3\ : label is "soft_lutpair1";
begin
...
\tx_ctrl[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FE00FEFF02000200"
    )
        port map (
      I0 => PWDATA(0),
      I1 => PADDR(0),
      I2 => \tx_ctrl[0]_i_2_n_0\,
      I3 => \^apb_txff_wr0\,
      I4 => \tx_ctrl[0]_i_3_n_0\,
...
\tx_ctrl[0]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo_generator is
  ...
  signal \PRDATA_reg[7]_i_5_n_0\ : STD_LOGIC;
...
\PRDATA[7]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"EEE222E200000000"
        ...
        port map (
      I0 => \PRDATA_reg[7]_i_5_n_0\,
      I1 => \rd_ptr_reg__0\(3),
      I2 => \PRDATA[7]_i_6_n_0\,
      I3 => \rd_ptr_reg__0\(2),
      I4 => \PRDATA[7]_i_7_n_0\,
      I5 => PADDR(2),
      O => D(7)
    );
...
\PRDATA_reg[7]_i_5\: unisim.vcomponents.MUXF7
     port map (
      I0 => \PRDATA[7]_i_8_n_0\,
      I1 => \PRDATA[7]_i_9_n_0\,
      O => \PRDATA_reg[7]_i_5_n_0\,
      S => \rd_ptr_reg__0\(2)
    );
...
apb_interface: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_apb_interface
     port map (
      ...
      D(1) => fifo_rx_0_n_6,
      D(0) => fifo_rx_0_n_7,
      DI(3) => apb_interface_n_31,
      DI(2) => apb_interface_n_32,
      DI(1) => apb_interface_n_33,
      DI(0) => apb_interface_n_34,
      E(0) => fifo_rx_0_n_8,
      PADDR(2 downto 0) => PADDR(2 downto 0),
      PCLK => PCLK,
      PENABLE => PENABLE,
      ...
      S(3) => apb_interface_n_7,
      S(2) => apb_interface_n_8,
      S(1) => apb_interface_n_9,
      S(0) => apb_interface_n_10,
      apb_rxff_rd => apb_rxff_rd,
      apb_rxff_rd_reg_0 => fifo_tx_0_n_10,
      apb_txff_wr => apb_txff_wr,
      apb_txff_wr0 => apb_txff_wr0,
      apb_txff_wr_reg_0 => fifo_tx_0_n_11,
      clk_en_reg(2) => apb_interface_n_35,
      clk_en_reg(1) => apb_interface_n_36,
      clk_en_reg(0) => apb_interface_n_37,
      counter(2 downto 0) => counter(2 downto 0),
      \counter_byte_reg[1]\(3) => apb_interface_n_38,
      \counter_byte_reg[1]\(2) => apb_interface_n_39,
      \counter_byte_reg[1]\(1) => apb_interface_n_40,
      \counter_byte_reg[1]\(0) => apb_interface_n_41,
      ...
      sclk_reg(3) => apb_interface_n_27,
      sclk_reg(2) => apb_interface_n_28,
      sclk_reg(1) => apb_interface_n_29,
      sclk_reg(0) => apb_interface_n_30,
      sda_o_reg => apb_interface_n_50,
...
i2c_master: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_i2c_master
     port map (
      ...
      counter_reg(15 downto 0) => \div_clk/counter_reg\(15 downto 0),
      \counter_reg[2]_0\ => apb_interface_n_50,
      ...
      \tx_apb_data_cnt_reg[7]\(3) => apb_interface_n_38,
      \tx_apb_data_cnt_reg[7]\(2) => apb_interface_n_39,
      \tx_apb_data_cnt_reg[7]\(1) => apb_interface_n_40,
      \tx_apb_data_cnt_reg[7]\(0) => apb_interface_n_41,
      \tx_apb_data_cnt_reg[7]_0\(7 downto 0) => data_cnt(7 downto 0),
      \tx_div_cnt_reg[14]\(2) => apb_interface_n_35,
      \tx_div_cnt_reg[14]\(1) => apb_interface_n_36,
      \tx_div_cnt_reg[14]\(0) => apb_interface_n_37,
      \tx_div_cnt_reg[15]\(3) => apb_interface_n_27,
      \tx_div_cnt_reg[15]\(2) => apb_interface_n_28,
      \tx_div_cnt_reg[15]\(1) => apb_interface_n_29,
      \tx_div_cnt_reg[15]\(0) => apb_interface_n_30,
